...
The easiest way to migrate all your test cases at once is to change the [default element selector](../../apis-tools/testing/assertions.md#element-selector) in the configuration.
